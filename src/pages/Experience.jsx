...
function ExperiencePage() {
  ...
  const experiences = [
    {
      ...
      description: "Worked on frontend web projects, WordPress sites, and UI/UX designs using Figma. Collaborated closely with teams to deliver responsive, user-friendly websites.",
      skills: ["React", "WordPress", "Figma", "JavaScript", "Tailwind CSS"],
      logo: "/CompanyLogo/anclogo1.jpeg"
    },
    {
      id: 2,
      ...
      description: "Completed MERN stack training and developed multiple full stack projects. Focused on building real-world applications using MongoDB, Express, React, and Node.js.",
      skills: ["MongoDB", "Express", "React", "Node.js", "JavaScript", "REST APIs"],
      logo: "/CompanyLogo/mern.png"
    },
    {
      id: 3,
      title: "SEO & Blogging Learner",
      company: "iSkills",
      period: "Nov 2025 - Present",
      description: "Currently enrolled in iSkills to learn SEO, blogging, Google Ads, and other digital freelancing skills to build a successful independent career.",
      skills: ["SEO", "Blogging", "Google Ads", "Freelancing", "Content Marketing"],
      logo: "/CompanyLogo/SEO.png"
    }
  ];
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Node.js", "Express", "MongoDB", "REST APIs", "MERN Stack"]
    },
    {
      category: "CMS & SEO",
      skills: ["WordPress", "SEO Basics", "Blogging", "Google Ads"]
    },
    {
      category: "Tools & Others",
      skills: ["Git", "GitHub", "VS Code", "Figma", "Vercel", "Netlify"]
  ...
  return (
    <div className="bg-[#000319] text-white min-h-screen">
      ...
      <PageHero
        headingWhite="My"
        headingPur="Experience"
        desc="A comprehensive overview of my professional experience, education, and skills, highlighting my growth and expertise in web development and SEO."
      />
