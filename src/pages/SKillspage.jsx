    ...
    <div className="bg-[#000319] text-white min-h-screen">
      ...
      <section className="relative py-20 bg-[#080810]">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-4xl sm:text-5xl font-bold mb-4">My <span className="text-[#A78BFA]">Skills</span></h1>
            <p className="text-gray-400 max-w-2xl mx-auto">
              A comprehensive overview of my technical expertise, tools, and soft skills
